...
export function TripFormModal({ trip, onClose, onSubmit }: TripFormModalProps) {
  ...
  return (
    <FormSheet
      title={isEditing ? strings.editTrip.title : strings.createTrip.title}
      onSubmit={handleSubmit}
      onClose={onClose}
      cancelLabel={strings.createTrip.cancel}
      submitLabel={isEditing ? strings.editTrip.submit : strings.createTrip.submit}
