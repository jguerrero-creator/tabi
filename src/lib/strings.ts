...
export const strings = {
  ...
  tripLegs: {
    ...
    noInfoCompact: (from: string, to: string) => `${from} → ${to} — no travel time available, tap to change mode`,
  ...
  vehicleRentalLegs: {
    ...
    departurePlaceLabel: 'Departure place',
    departureTimeLabel: 'Departure time',
    arrivalPlaceLabel: 'Arrival place',
    arrivalTimeLabel: 'Arrival time',
    save: 'Save',
    cancel: 'Cancel',
    delete: 'Delete',
    deleteConfirm: 'Delete this leg? This cannot be undone.',
    errorDateOutOfRange: "This date falls outside the rental's pick-up–drop-off range.",
    errorPlaceRequired: 'Select a place from the suggestions for both departure and arrival.',
    errorArrivalBeforeDeparture: 'Arrival must be after departure.',
    errorGeneric: 'Something went wrong. Please try again.',
  ...
  addReservation: {
    ...
    // mode the AI/user never determined) and must never block or default to a guess.
    transportModeLabel: 'Mode',
    transportModeUnset: 'Not set',
    transportModes: {
      flight: 'Flight',
      train: 'Train',
      bus: 'Bus',
