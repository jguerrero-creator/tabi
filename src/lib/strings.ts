    ...
    sections: [
      {
        ...
        list: [
          ...
          'Reservation data: booking type, name, price, status (Booked / To book / Decide later), notes, and — for stay, transport, and activity items — addresses, place names, geographic coordinates (latitude/longitude), and time zone, resolved via Google’s Geocoding and Time Zone APIs.',
